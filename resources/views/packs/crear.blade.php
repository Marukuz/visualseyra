                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="border rounded focus:outline-none focus:shadow-outline p-2 mb-4 form-control" name="contenido" rows="5" cols="127" placeholder="Describe el contenido del pack.">{{old('contenido')}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
